...
#'
#' @aliases CENTREannotDb-class show dbconn,CENTREannotDb-method show,CENTREannotDb-method
#'
#' @description
#'
#' The `CENTREannotDb` object provides access to the ENCODE screen V3 annotation 
#' for Human https://screen.encodeproject.org.
#'
#' @details
#'
#' `CENTREannotDb` is the object that provides access to CENTRE's database.
#' `CENTREannotDb@.properties$tables` shows the tables inside the database and
#' their columns.
...
setValidity("CENTREannotDb", function(object) {
  con <- .dbconn(object)
  if (!is.null(con)) {

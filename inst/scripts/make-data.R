...
# - gene_id1: gene id without version identifier
# - transcript_id: ENSEMBL transcript id
# - gene_name: name o the gene
# - description: Type of gene
# - transcription_start: TSS position of the gene
# - new_start: starting position of the extended TSS. We extended the TSS to a 
#             size of 499.
